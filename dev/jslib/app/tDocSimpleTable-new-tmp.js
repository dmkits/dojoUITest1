 ...
 */
define(["dojo/_base/declare", "dojo/text!./tDocSimpleTable-new-tmp.html", "app/base", "app/tDocBase","dijit/form/Select", "app/hTableSimpleFiltered","app/request"],
    function(declare, tDocSimpleTableHTML, base, DocumentBase,Select, HTable, Request) {
        var t="";
        return declare("TDocSimpleTable", [DocumentBase], {
            ...
            * */
            ...
            postCreate: function(){                                                         console.log("TDocSimpleTable children",this.getChildren(),this.domNode);
                ...
                this.parseDocChilrderTags();
            },

            parseDocChilrderTags:function(){
                ...
                for(var i=0;i<this.domNode.children.length;i++){
                    ...
                    else if(cNodeAtrDocPart=="right") cNode.setAttribute("region","right");
                    ...
                    if(cNodeAtrDocPart!=="htable"&&cNodeAtrDocPart!=="right")cNode.style.border=cNode.style.border||"none";
