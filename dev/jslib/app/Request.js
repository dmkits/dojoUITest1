define(["dojo/_base/declare","dojo/request","app/base","app/Dialog"],
    function(declare,request,base,dialog){
        return declare("Request",request,{
            constructor: function(args){
                declare.safeMixin(this,args);
                this.jsonHeader= {"X-Requested-With":"application/json; charset=utf-8",
                    'Content-Type': 'application/x-www-form-urlencoded'};
                this.showRequestErrorDialog= false;
            },
            /** getJSON
            ...
            showRequestFailDialog: function(params) {
                if(!params) params={};
            ...
            getJSONData: function(params, resultCallback){
                ...
                if (params.showRequestErrorDialog!==false)
                    requestFailDialog= function(msg){
                        this.showRequestFailDialog({title:"Внимание",content:"Невозможно получить данные! <br>Причина:"+msg});
                    };
            ...
            postJSONData: function (params,resultCallback) {
                ...
                if (params.showRequestErrorDialog!==false)
                    requestFailDialog= function(msg, reason){
                        if(!reason) reason="";
                        this.showRequestFailDialog({title:"Внимание",content:msg+" <br>Причина:"+reason});
                    };
